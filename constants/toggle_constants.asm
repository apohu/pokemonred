...
; after battle and are detected in wToggleableObjectList.)
	...
	const TOGGLE_VIRIDIAN_FOREST_ROCKET_LEADER
	const TOGGLE_VIRIDIAN_FOREST_BEAUTY_1
	const TOGGLE_VIRIDIAN_FOREST_BEAUTY_2
	const TOGGLE_VIRIDIAN_FOREST_BEAUTY_3
	const TOGGLE_VIRIDIAN_FOREST_BEAUTY_4
	const TOGGLE_VIRIDIAN_FOREST_BEAUTY_5
