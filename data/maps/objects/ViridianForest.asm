	...
	const_export VIRIDIANFOREST_ROCKET_LEADER
	const_export VIRIDIANFOREST_BEAUTY_1
	const_export VIRIDIANFOREST_BEAUTY_2
	const_export VIRIDIANFOREST_BEAUTY_3
	const_export VIRIDIANFOREST_BEAUTY_4
	const_export VIRIDIANFOREST_BEAUTY_5
...
ViridianForest_Object:
	...
	object_event 9, 24, SPRITE_ROCKET, STAY, LEFT, TEXT_VIRIDIANFOREST_ROCKET_LEADER, OPP_ROCKET, 42
	object_event 19, 42, SPRITE_BEAUTY, STAY, DOWN, TEXT_VIRIDIANFOREST_BEAUTY_1, OPP_BEAUTY, 16
	object_event 14, 16, SPRITE_BEAUTY, STAY, RIGHT, TEXT_VIRIDIANFOREST_BEAUTY_2, OPP_BEAUTY, 17
	object_event 27, 24, SPRITE_BEAUTY, WALK, NONE, TEXT_VIRIDIANFOREST_BEAUTY_3
	object_event 16, 6, SPRITE_BEAUTY, WALK, NONE, TEXT_VIRIDIANFOREST_BEAUTY_4
	object_event 6, 10, SPRITE_BEAUTY, WALK, NONE, TEXT_VIRIDIANFOREST_BEAUTY_5
